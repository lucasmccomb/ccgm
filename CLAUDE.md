...
CCGM is a modular Claude Code configuration system. It contains 77 modules that users can selectively install to configure Claude Code's behavior, hooks, commands, and permissions.
