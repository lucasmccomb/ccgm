...
CCGM is a modular Claude Code configuration system. It contains 76 modules that users can selectively install to configure Claude Code's behavior, hooks, commands, and permissions.
...
├── modules/            # 76 self-contained modules
│   └── {name}/
