...
CCGM is a modular Claude Code configuration system. It contains 67 modules that users can selectively install to configure Claude Code's behavior, hooks, commands, and permissions.
...
├── modules/            # 67 self-contained modules
│   └── {name}/
