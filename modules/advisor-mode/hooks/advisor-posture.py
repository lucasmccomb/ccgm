...
CONTEXT = (
    ...
    "for hard units), personally review spec compliance and quality with "
    "explicit success criteria, run normal repository checks, and delegate fixes "
    "(max 3 rounds, then escalate). Cross-provider review is opt-in and bounded; a stopped optional review is never approval. Route plan- or issue-shaped work through "
